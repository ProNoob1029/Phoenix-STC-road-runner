...
public class RedWithCaruselAndStorage extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence trajSeq3 = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToSplineHeading(new Pose2d(-24.2, -23.34, Math.toRadians(0)), Math.toRadians(0))
        ...
        TrajectorySequence trajSeq2 = drive.trajectorySequenceBuilder(startPose)
                ...
                .setTangent(Math.toRadians(90))
                .splineToSplineHeading(new Pose2d(-58, -40, Math.toRadians(67)), Math.toRadians(90))
                .splineToSplineHeading(new Pose2d(-25.2, -23.34, Math.toRadians(0)), Math.toRadians(0))
        ...
        TrajectorySequence trajSeq1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .setTangent(Math.toRadians(90))
                .splineToSplineHeading(new Pose2d(-58, -40, Math.toRadians(67)), Math.toRadians(90))
                .splineToSplineHeading(new Pose2d(-26.2, -23.34, Math.toRadians(0)), Math.toRadians(0))
