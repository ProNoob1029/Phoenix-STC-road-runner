...
public abstract class SampleTeleOp extends LinearOpMode {
    ...
    public void movement(){
        ...
        Vector2d input = getDriveInput(leftX, leftY, poseEstimate.getHeading());
    ...
    public abstract Vector2d getDriveInput(double leftX, double leftY, double heading);

    public abstract void setCaruselPower();
}